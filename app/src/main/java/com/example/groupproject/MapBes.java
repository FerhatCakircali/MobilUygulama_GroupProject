...
public class MapBes extends AppCompatActivity implements OnMapReadyCallback{
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) { // Haritanın başlangıç konum
        ...
        if (mLocationPermissionsGranted) {
            ...
            mMap.setMyLocationEnabled(true);// böylece bizim konumdan başlayacak
    ...
    private void getDeviceLocation(){// lokasyona geri döndür
        Log.d(TAG,"getDeviceLocation: cihazların mevcut konumunu alma");
                ...
                location.addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if (task.isSuccessful()){
                            Log.d(TAG,"onComplate:Bulunan yer");
                            Location currentLocation=(Location) task.getResult();

                            moveCamera(new LatLng(currentLocation.getLatitude(),currentLocation.getLongitude()),
                                    DEFAULT_ZOOM,"My Location" );
                        }else{
                            Log.d(TAG,"onComplate: geçerli konum konumu boş");
                            Toast.makeText(MapBes.this, "mevcut konum alınamıyor", Toast.LENGTH_SHORT).show();
                        }
    ...
    private void moveCamera(LatLng latLng,float zoom,String title){//verilen parametrelere göre ZOOM yapma
        Log.d(TAG,"moveCamera:Ekran hareketi: lat:" + latLng.latitude +", lng" + latLng.longitude);
    ...
    private void getLocationPermission(){// kullanıcıdan konum için izin isteme
        Log.d(TAG,"getLocationPermission: konum izni al");
    ...
    @Override
    //Konum izni için verilen seçeneklere göre haritayı yükler
